...
resource "azurerm_resource_group" "rg" {
  # Adding a 'v2' to the name to ensure a 100% fresh start
  name     = "DevOps-Final-Deployment-RG-v2" 
  location = "France Central" # Generally high availability for Free Tiers
}
